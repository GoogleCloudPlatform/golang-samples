...
// [START securitycenter_create_big_query_export]
...
func createBigQueryExport(w io.Writer, parent string, bigQueryExportId string, bigQueryDatasetName string) error {
...
// [END securitycenter_create_big_query_export]

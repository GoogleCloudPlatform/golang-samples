...
require (
	github.com/GoogleCloudPlatform/golang-samples 2a6361b94cd7
	github.com/GoogleCloudPlatform/golang-samples/run/grpc-ping 2a6361b94cd7
	github.com/GoogleCloudPlatform/golang-samples/run/grpc-server-streaming 2a6361b94cd7

...
require (
	...
	github.com/GoogleCloudPlatform/golang-samples/run/grpc-ping v0.0.0-20211020191508-fa7b610d56d1
	github.com/GoogleCloudPlatform/golang-samples/run/grpc-server-streaming v0.0.0-20211020191508-fa7b610d56d1

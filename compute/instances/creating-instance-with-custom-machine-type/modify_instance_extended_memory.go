...
// modifyInstanceWithExtendedMemory sends an instance creation request to the Compute Engine API and wait for it to complete.
func modifyInstanceWithExtendedMemory(w io.Writer, projectID, zone, instanceName string, newMemory int) error {

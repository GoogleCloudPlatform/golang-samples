...
func createInstanceWithExtraMemWithoutHelper(w io.Writer, projectID, zone, instanceName, cpuSeries string, coreCount, memory int) error {
	...
	machineType := fmt.Sprintf("zones/%s/machineTypes/%v-%v-%v-ext", cpuSeries, zone, coreCount, memory)

...
func pullMsgsSync(w io.Writer, projectID, subName string, maxMessages int32) error {
	...
	// Instantiate a subscriber client. Note, this uses an autogenerated
	// versioned client, cloud.google.com/go/pubsub/apiv1, which differs
	// than the usual cloud.google.com/go/pubsub client which should be
	// used in most cases.
	...
	// The following Pull RPC is not exposed directly in cloud.google.com/pubsub,
	// and is the reason why we instantiated a versioned client.
	// For more innformation, see https://cloud.google.com/pubsub/docs/reference/rpc/google.pubsub.v1#google.pubsub.v1.PullRequest.

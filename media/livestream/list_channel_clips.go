...
// listChannelClips lists all channel clips for a given channel.
func listChannelClips(w io.Writer, projectID, channelID string) error {
	...
	for {
		...
		if err != nil {
			return fmt.Errorf("ListClips: %w", err)
		}

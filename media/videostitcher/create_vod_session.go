...
func createVodSession(w io.Writer, projectID, sourceURI, adTagURI string) error {
	...
	// See VMAP Pre-roll (https://developers.google.com/interactive-media-ads/docs/sdks/html5/client-side/tags)

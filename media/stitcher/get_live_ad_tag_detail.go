...
func getLiveAdTagDetail(w io.Writer, projectID, location, sessionID, adTagDetailID string) error {
	...
	if err != nil {
		return fmt.Errorf("GetLiveAdTagDetail: %v", err)
	}

	fmt.Fprintf(w, "Live ad tag detail: %v", response.Name)
	return nil
}

...
// deleteCdnKey deletes a previously-created CDN key.
func deleteCdnKey(w io.Writer, projectID, location, cdnKeyID string) error {
	...
	if err != nil {
		return fmt.Errorf("DeleteCdnKey: %v", err)
	}

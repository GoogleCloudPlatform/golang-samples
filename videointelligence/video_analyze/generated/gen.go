...
func main() {
	...
	normal = strings.Replace(normal, "// Input boilerplate", "InputContent: fileBytes,", -1)
	...
	gcs = strings.Replace(gcs, "// Input boilerplate", "InputUri: file,", -1)
	out.WriteString(gcs)

	if err := ioutil.WriteFile("video_analyze.go", out.Bytes(), 0640); err != nil {
		log.Fatal(err)
	}
}

const boilerplateSentinel = "\tvar client *video.Client // Boilerplate is inserted by gen.go\n"

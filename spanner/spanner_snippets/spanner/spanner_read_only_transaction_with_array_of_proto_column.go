...
// [START spanner_read_only_transaction_with_array_of_proto_column]

func readOnlyTransactionWithArrayOfProtoMsgAndEnum(w io.Writer, db string) error {
...
// [END spanner_read_only_transaction_with_array_of_proto_column]

...
func composeFile(w io.Writer, bucket, object1, object2, toObject string, deleteSourceObjects bool) error {
	...
	c.DeleteSourceObjects = deleteSourceObjects
	_, err = c.Run(ctx)
	if err != nil {
	...
	if deleteSourceObjects {
		deletionMessage = " and the source objects were deleted."
	}
	fmt.Fprintf(w, "New composite object %v was created by combining %v and %v%v\n", toObject, object1, object2, deletionMessage)
	return nil
}

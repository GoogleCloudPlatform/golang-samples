...
// deleteFolderRecursive deletes the folder with the given name recursively.
func deleteFolderRecursive(w io.Writer, bucket, folder string) error {
	...
	// DeleteFolderRecursive returns an operation
	...
	if err := op.Wait(ctx); err != nil {
		return fmt.Errorf("DeleteFolderRecursive Wait: %w", err)
	}

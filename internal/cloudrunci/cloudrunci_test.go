		...
		},
		{
			...
			readiness: &struct {
				...
				GRPC: &struct {
					Port    int
					Service string
				}{Port: 50051, Service: "myservice"},
			},
			wantArgs: []string{"--readiness-probe=timeoutSeconds=10,periodSeconds=5,successThreshold=1,failureThreshold=3,grpc.port=50051,grpc.service=myservice"},
		},
	}

...
func TestDetect(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if got := buf.String(); !responseContains(got, tt.wantContain) {
...
// responseContains checks the response for a string in a case-insensitive fashion.
func responseContains(haystack string, needle string) bool {

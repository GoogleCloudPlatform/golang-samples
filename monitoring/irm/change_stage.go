...
// changeStage changes the stage of the incident.
func changeStage(w io.Writer, incidentName string) error {
	...
	fmt.Fprintf(w, "Changed stage of %q", incident.Name)

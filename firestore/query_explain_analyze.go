...
func queryExplainAnalyze(w io.Writer, projectID string) error {
	...
	it := query.WithRunOptions(firestore.ExplainOptions{Analyze: true}).
		Documents(ctx)
	...
	// Get execution stats
	executionStats := explainMetrics.ExecutionStats

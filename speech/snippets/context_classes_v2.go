...
// [START speech_context_classes_v2]
...
func contextClasses(w io.Writer, gcsURI string) error {
	...
	// https://cloud.google.com/speech-to-text/docs/reference/rpc/google.cloud.speech.v2#speechcontext

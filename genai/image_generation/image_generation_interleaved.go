...
// [START genai_image_generation_interleaved]
import (
	"context"
	"fmt"
	"io"
...
// generateContent generates interleaved image and text outputs for a given input text prompt.
func generateContent(w io.Writer) error {
	...
	textpart := genai.Text("Generate an illustrated recipe of a paella, including photos for each step.")
...
// [END genai_image_generation_interleaved]

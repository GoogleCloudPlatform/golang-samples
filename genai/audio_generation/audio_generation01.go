...
// [START genai_audio_generation01]
import (
	"context"
	"fmt"
	"io"
...
// generateAudio generates a synthetic text-to-speech audio file.
func generateAudio(w io.Writer) error {
	...
	instance := genai.Text("Say \"Thanks for calling!\" in a salesperson voice.")

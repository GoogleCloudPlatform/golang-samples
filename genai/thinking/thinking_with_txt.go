...
// generateContentWithTxt demonstrates how to generate text with thinking model.
func generateContentWithTxt(w io.Writer) error {
	...
	//
	//### Method 1: Factoring
	// This equation is a perfect square trinomial. This means it fits the pattern a² + 2ab + b² = (a + b)².

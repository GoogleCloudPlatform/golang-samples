...
// controlledGenerationResponseMimeType shows how to make sure the generated output
// will always be valid JSON.
func controlledGenerationResponseMimeType(w io.Writer, projectID, location, modelName string) error {
